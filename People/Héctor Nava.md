...
mail: false 
respond: false
institution: Laboratorio	de	Biodiversidad Marina,	 Departamento de	Zoología, Instituto	 de Investigaciones sobre los Recursos Naturales,	Universidad	Michoacana	de	San	 Nicolás	de	Hidalgo
country: Mexico
summary: 
---
# info 
Mail: hector.nava@umich.mx

# Article involved
```dataview 
Table title from [[Héctor Nava]]
where contains(tipe, "journalArticle")
```

# Mail chat gpt

create a mail destinated to Héctor Nava to ask if there is a Ph.D position in the lab 
