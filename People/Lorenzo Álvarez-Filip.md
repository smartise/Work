...
mail: false
respond: false
institution: Universidad Nacional Autónoma de México, Instituto de Ciencias del Mar y Limnología, Unidad Académica de Sistemas Arrecifales, Biodiversity and Reef Conservation Laboratory
country: México
summary:
---
# info 
Mail: [lorenzo@cmarl.unam.mx](mailto:lorenzo@cmarl.unam.mx)

# Article involved
```dataview 
Table title from [[Lorenzo Álvarez-Filip]]
where contains(tipe, "journalArticle")
```

# Mail chat gpt

create a mail destinated to Lorenzo Álvarez-Filip to ask if there is a Ph.D position in the lab 
