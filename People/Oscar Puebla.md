...
---
# info 
Mail: [oscar.puebla@mail.mcgill.ca](mailto:oscar.puebla@mail.mcgill.ca)  

# Article involved
```dataview 
Table title from [[Oscar Puebla]]
where contains(tipe, "journalArticle")
```

# Mail chat gpt

create a mail destinated to Oscar Puebla to ask if there is a Ph.D position in the lab 
